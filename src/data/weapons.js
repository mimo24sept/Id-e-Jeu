const WEAPON_ARCHETYPES = [
  ...
  },
  {
    ...
    projectileSpeed: 800,
    accuracy: 0.04,
    healthBonusMultiplier: 0.10,
    moveSpeedBonus: 15,
  },
  {
    id: "lance-grenades",
    name: "Lance-grenades",
    fireLabel: "tir explosif",
    basePrice: 38,
    baseCooldown: 1.9,
    damage: 52,
    range: 340,
    projectileSpeed: 225,
    accuracy: 0.07,
    healthBonusMultiplier: 0.16,
    moveSpeedBonus: -35,
    forceExplosive: true,
  },
  {
    id: "rafale",
    name: "Fusil en rafale",
    fireLabel: "rafale ×3",
    basePrice: 28,
    baseCooldown: 0.5,
    damage: 9,
...
const WEAPON_SCALING_TYPES = [
  ...
  },
  {
    ...
    apply(effects, count, mult) {
      effects.maxHpMultiplier += count * 0.06 * mult;
