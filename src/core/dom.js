...
const ui = {
  ...
  waveAnnouncement: document.querySelector("#waveAnnouncement"),
  waveAnnouncementLabel: document.querySelector("#waveAnnouncementLabel"),
  waveAnnouncementTitle: document.querySelector("#waveAnnouncementTitle"),
  waveAnnouncementDesc: document.querySelector("#waveAnnouncementDesc"),
  objectivePanel: document.querySelector("#objectivePanel"),
  objectivePanelTitle: document.querySelector("#objectivePanelTitle"),
  objectivePanelProgress: document.querySelector("#objectivePanelProgress"),
  objectivePanelDesc: document.querySelector("#objectivePanelDesc"),
